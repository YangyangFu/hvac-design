function varargout = figure6x1(varargin)
% FIGURE6X1 MATLAB code for figure6x1.fig
%      FIGURE6X1, by itself, creates a new FIGURE6X1 or raises the existing
%      singleton*.
%
%      H = FIGURE6X1 returns the handle to a new FIGURE6X1 or the handle to
%      the existing singleton*.
%
%      FIGURE6X1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FIGURE6X1.M with the given input arguments.
%
%      FIGURE6X1('Property','Value',...) creates a new FIGURE6X1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before figure6x1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to figure6x1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help figure6x1

% Last Modified by GUIDE v2.5 16-Oct-2015 14:04:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @figure6x1_OpeningFcn, ...
                   'gui_OutputFcn',  @figure6x1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before figure6x1 is made visible.
function figure6x1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to figure6x1 (see VARARGIN)

% Choose default command line output for figure6x1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes figure6x1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = figure6x1_OutputFcn(hObject, eventdata, handles) 
...
% –¥»Îtopology–Œ Ω
TopologyOpt='EnergyStation 1 control Zone 1,Zone 2,Zone 3,Zone4,Zone5,Zone6';
...
Zone5HEXSPDF=get(handles.edit37,'String');
Zone5HEXSPDP=get(handles.edit38,'String');
HeatEx5DF=get(handles.edit39,'String');
HeatEx5N=get(handles.edit40,'String');
Zone6SPDF=get(handles.edit41,'String');
Zone6SPDP=get(handles.edit42,'String');
%build matrix 2
B=[{Zone3HEXSPDF};{Zone3HEXSPDP};{HeatEx3DF};{HeatEx3N};{Zone4SPDF};{Zone4SPDP};...
   ...
   {Zone5HEXSPDF};{Zone5HEXSPDP};{HeatEx5DF};{HeatEx5N};{Zone6SPDF};{Zone6SPDP} ];

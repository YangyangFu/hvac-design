function [h,W,Tdp]=PsychTdbRH(Tdb,RH,barom_pressure)
...
% saturation humidity ratio: Ws,equation 23
Ws=0.621945*ps./(barom_pressure-ps);
% degree of saturation :miu,equation 12
miu=W./Ws;
% specific volume of moist air mixture:v[m3/kg(da)],equation 28
v=0.287042*T_obsolute.*(1+1.607858*W)./barom_pressure;

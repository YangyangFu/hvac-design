...
for i=1:r1
    Tr=Tr_matrix(i)*ones(r2,1);

        Tw_out(:,i)=Coeff(1) + Coeff(2).*FRair + Coeff(3).*(FRair).^2 + ...
         ...
         h_air_in(:,i)=PsychTdbRH(Twb,1);
         hs_water_in(:,i)=PsychTdbRH(Tr+Tw_out(:,i),1.00);
         epsilon(:,i)=1.5*4200.*Tr./(1.6435*1.29.*(hs_water_in(:,i)-h_air_in(:,1)));
end

function varargout = figure4x1(varargin)
% FIGURE4X1 MATLAB code for figure4x1.fig
%      FIGURE4X1, by itself, creates a new FIGURE4X1 or raises the existing
%      singleton*.
%
%      H = FIGURE4X1 returns the handle to a new FIGURE4X1 or the handle to
%      the existing singleton*.
%
%      FIGURE4X1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FIGURE4X1.M with the given input arguments.
%
%      FIGURE4X1('Property','Value',...) creates a new FIGURE4X1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before figure4x1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to figure4x1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help figure4x1

% Last Modified by GUIDE v2.5 16-Oct-2015 13:13:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @figure4x1_OpeningFcn, ...
                   'gui_OutputFcn',  @figure4x1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before figure4x1 is made visible.
function figure4x1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to figure4x1 (see VARARGIN)

% Choose default command line output for figure4x1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes figure4x1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = figure4x1_OutputFcn(hObject, eventdata, handles) 
...
% –¥»Îtopology–Œ Ω
TopologyOpt='EnergyStation 1 control Zone 1,Zone 2,Zone 3,Zone 4';

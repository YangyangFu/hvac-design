function [UADesign,DesOutletWaterTemp,DesTotWaterCoilLoad]=DesignUA...
...
DesInletAirDewPoTemp=DesInletAir.DewPTemp;
...
[CBFTooLarge,BelowInletWaterTemp,DesOutletWaterTemp,DesTotWaterCoilLoad,...
    DesOutletAirEnth,UACoilExternal,~,~]=ByFactorEquation(DesInletAirTemp,...
    DesInletAirHumRat,DesOutletAirTemp,DesOutletAirHumRat,DesAirVolFlowRate,...
    ...
    function [CBFTooLarge,BelowInletWaterTemp,DesOutletWaterTemp,DesTotWaterCoilLoad,DesOutletAirEnth,UACoilExternal,UACoilInternal,UACoilTotal]=...
        ...
        if (DesOutletAirHumRat < DesInletAirHumRat)
            ...
            if (DesSatEnthAtWaterOutTemp > DesInletAirEnth)
                ...
                MaxWaterMassFlowRate = RhoWater * MaxWaterVolFlowRate;
                DesOutletWaterTemp = DesInletWaterTemp ...
                    + DesTotWaterCoilLoad / (MaxWaterMassFlowRate * Cp);

...
function [SmallON,MiddleON,LargeON]=FBasedChillerSequence(OperatingFlow,DesignFlow,MaxNum)


SmallDesignFlow=DesignFlow.Small;
MiddleDesignFlow=DesignFlow.Middle;
LargeDesignFlow=DesignFlow.Large;
...
SortedDataMinus=SortedData-OperatingFlow;
